...
This is a fork of the now read-only archived VarDict-Java 1.8.3 (latest release before archived). The purpose is
*NOT* to add additional functionality but rather to patch vulnerabilities as they arise.
